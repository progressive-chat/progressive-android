...
import chat.progressive.app.databinding.ViewJoinConferenceBinding
...
class JoinConferenceView @JvmOverloads constructor(
    ...
    override fun onAttachedToWindow() {
        ...
        val colorFrom = ContextCompat.getColor(context, chat.progressive.lib.ui.styles.R.color.palette_element_green)
        val colorTo = ContextCompat.getColor(context, chat.progressive.lib.ui.styles.R.color.join_conference_animated_color)
