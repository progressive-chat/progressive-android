...
import chat.progressive.app.core.error.ResourceLimitErrorFormatter
import chat.progressive.app.core.utils.DimensionConverter
import chat.progressive.app.databinding.ViewNotificationAreaBinding
...
class NotificationAreaView @JvmOverloads constructor(
    ...
    private fun renderNoPermissionToPost() {
        ...
        views.roomNotificationMessage.setTextColor(ThemeUtils.getColor(context, chat.progressive.lib.ui.styles.R.attr.vctr_content_secondary))
    }
    ...
    private fun renderResourceLimitExceededError(state: State.ResourceLimitExceededError) {
        ...
        if (state.isSoft) {
            backgroundColor = chat.progressive.lib.ui.styles.R.color.soft_resource_limit_exceeded
            formatterMode = ResourceLimitErrorFormatter.Mode.Soft
        } else {
            backgroundColor = chat.progressive.lib.ui.styles.R.color.hard_resource_limit_exceeded
