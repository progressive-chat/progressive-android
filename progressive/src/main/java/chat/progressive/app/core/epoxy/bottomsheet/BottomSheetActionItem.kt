 ...
 */
@EpoxyModelClass
abstract class BottomSheetActionItem : ProgressiveEpoxyModel<BottomSheetActionItem.Holder>(R.layout.item_bottom_sheet_action) {
    ...
    override fun bind(holder: Holder) {
        ...
        val tintColor = if (destructive) {
            ...
            ThemeUtils.getColor(holder.view.context, chat.progressive.lib.ui.styles.R.attr.vctr_content_secondary)
        }
