...
fun EditText.setupAsSearch(
        @DrawableRes searchIconRes: Int = chat.progressive.lib.ui.styles.R.drawable.ic_home_search,
        @DrawableRes clearIconRes: Int = chat.progressive.lib.ui.styles.R.drawable.ic_x_gray
) {
