...
package chat.progressive.app.core.preference
...
class ProgressivePreferenceCategory : PreferenceCategory {
    ...
    override fun onBindViewHolder(holder: PreferenceViewHolder) {
        ...
        titleTextView?.setTextColor(ThemeUtils.getColor(context, chat.progressive.lib.ui.styles.R.attr.vctr_content_primary))
