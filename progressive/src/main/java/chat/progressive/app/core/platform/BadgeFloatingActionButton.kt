...
class BadgeFloatingActionButton @JvmOverloads constructor(
    ...
    private fun initAttrs(attrs: AttributeSet) {
        context.obtainStyledAttributes(attrs, chat.progressive.lib.ui.styles.R.styleable.BadgeFloatingActionButton).use {
            counterBackgroundColor = it.getColor(chat.progressive.lib.ui.styles.R.styleable.BadgeFloatingActionButton_badgeBackgroundColor, 0)
            counterTextPadding = it.getDimension(chat.progressive.lib.ui.styles.R.styleable.BadgeFloatingActionButton_badgeTextPadding, 0f)
            counterTextSize = it.getDimension(chat.progressive.lib.ui.styles.R.styleable.BadgeFloatingActionButton_badgeTextSize, 14f)
            counterTextColor = it.getColor(chat.progressive.lib.ui.styles.R.styleable.BadgeFloatingActionButton_badgeTextColor, Color.WHITE)
        }
    }
