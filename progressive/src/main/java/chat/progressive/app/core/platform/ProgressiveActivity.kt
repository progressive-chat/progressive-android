...
import chat.progressive.app.core.di.ActivityEntryPoint
...
import chat.progressive.app.core.extensions.observeNotNull
...
import chat.progressive.app.features.rageshake.BugReportActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (progressivePreferences.isNewAppLayoutEnabled()) {
            tryOrNull { // Add to XML theme when feature flag is removed
                val toolbarBackground = MaterialColors.getColor(views.root, chat.progressive.lib.ui.styles.R.attr.vctr_toolbar_background)
