...
import chat.progressive.app.databinding.ViewSpaceTypeButtonBinding
...
//    var action: (() -> Unit)? = null
    ...
    init {
        ...
        context.withStyledAttributes(attrs, chat.progressive.lib.ui.styles.R.styleable.WizardButtonView) {
            title = getString(chat.progressive.lib.ui.styles.R.styleable.WizardButtonView_title)
            subTitle = getString(chat.progressive.lib.ui.styles.R.styleable.WizardButtonView_subTitle)
            icon = getDrawable(chat.progressive.lib.ui.styles.R.styleable.WizardButtonView_icon)
            tint = getColor(chat.progressive.lib.ui.styles.R.styleable.WizardButtonView_iconTint, -1)
                    .takeIf { it != -1 }
        }
