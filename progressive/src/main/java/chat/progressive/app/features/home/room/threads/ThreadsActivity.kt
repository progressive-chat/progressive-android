    ...
    fun navigateToThreadTimeline(threadTimelineArgs: ThreadTimelineArgs) {
        ...
        val commonOption: (FragmentTransaction) -> Unit = {
            it.setCustomAnimations(
                    chat.progressive.lib.ui.styles.R.anim.animation_slide_in_right,
                    chat.progressive.lib.ui.styles.R.anim.animation_slide_out_left,
                    chat.progressive.lib.ui.styles.R.anim.animation_slide_in_left,
                    chat.progressive.lib.ui.styles.R.anim.animation_slide_out_right
            )
        }
