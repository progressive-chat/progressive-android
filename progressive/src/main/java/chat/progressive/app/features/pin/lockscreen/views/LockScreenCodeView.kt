...
package chat.progressive.app.features.pin.lockscreen.views
...
class LockScreenCodeView @JvmOverloads constructor(
    ...
    private fun setupCodeViews() {
        ...
        repeat(codeLength) { index ->
            ...
            val margin = resources.getDimensionPixelSize(chat.progressive.lib.ui.styles.R.dimen.lockscreen_code_margin)
