...
import chat.progressive.app.features.raw.wellknown.SecureBackupMethod
...
) : ProgressiveViewModel<BootstrapViewState, BootstrapActions, BootstrapViewEvents>(initialState) {
