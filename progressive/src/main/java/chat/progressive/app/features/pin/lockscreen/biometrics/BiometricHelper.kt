...
import chat.progressive.app.features.pin.lockscreen.utils.hasFlag
...
class BiometricHelper @AssistedInject constructor(
    ...
    internal fun authenticateWithPromptInternal(
        ...
        val cancelButtonTitle = configuration.biometricCancelButtonTitle ?: context.getString(chat.progressive.lib.ui.styles.R.string.lockscreen_cancel)
        val promptInfo = BiometricPrompt.PromptInfo.Builder()
                .setTitle(configuration.biometricTitle ?: context.getString(chat.progressive.lib.ui.styles.R.string.lockscreen_sign_in))
                .apply {
