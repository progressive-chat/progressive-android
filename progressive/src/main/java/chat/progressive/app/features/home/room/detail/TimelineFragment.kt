...
import chat.progressive.app.core.dialogs.ConfirmationDialogBuilder
...
import chat.progressive.app.core.epoxy.LayoutManagerStateRestorer
import chat.progressive.app.core.extensions.cleanup
import chat.progressive.app.core.extensions.commitTransaction
import chat.progressive.app.core.extensions.containsRtLOverride
import chat.progressive.app.core.extensions.ensureEndsLeftToRight
import chat.progressive.app.core.extensions.filterDirectionOverrides
...
import chat.progressive.app.core.glide.GlideRequests
...
import chat.progressive.app.core.ui.views.FailedMessagesWarningView
import chat.progressive.app.core.ui.views.JoinConferenceView
import chat.progressive.app.core.ui.views.NotificationAreaView
import chat.progressive.app.core.utils.Debouncer
import chat.progressive.app.core.utils.DimensionConverter
import chat.progressive.app.core.utils.KeyboardStateUtils
import chat.progressive.app.core.utils.PERMISSIONS_FOR_WRITING_FILES
...
import chat.progressive.app.core.utils.openLocation
...
import chat.progressive.app.core.utils.safeStartActivity
import chat.progressive.app.core.utils.saveMedia
import chat.progressive.app.core.utils.shareMedia
import chat.progressive.app.core.utils.shareText
import chat.progressive.app.core.utils.startInstallFromSourceIntent
...
import chat.progressive.app.features.call.conference.ConferenceEventEmitter
import chat.progressive.app.features.call.conference.ConferenceEventObserver
...
import chat.progressive.app.features.home.room.detail.composer.CanSendStatus
import chat.progressive.app.features.home.room.detail.composer.MessageComposerAction
import chat.progressive.app.features.home.room.detail.composer.MessageComposerFragment
...
import chat.progressive.app.features.home.room.detail.composer.voice.VoiceRecorderFragment
import chat.progressive.app.features.home.room.detail.error.RoomNotFound
...
import chat.progressive.app.features.home.room.detail.timeline.item.MessageAudioItem
import chat.progressive.app.features.home.room.detail.timeline.item.MessageFileItem
import chat.progressive.app.features.home.room.detail.timeline.item.MessageImageVideoItem
import chat.progressive.app.features.home.room.detail.timeline.item.MessageInformationData
import chat.progressive.app.features.home.room.detail.timeline.item.MessageTextItem
import chat.progressive.app.features.home.room.detail.timeline.item.MessageVoiceItem
...
import chat.progressive.app.features.home.room.detail.timeline.readreceipts.DisplayReadReceiptsBottomSheet
import chat.progressive.app.features.home.room.detail.timeline.url.PreviewUrlRetriever
import chat.progressive.app.features.home.room.detail.upgrade.MigrateRoomBottomSheet
import chat.progressive.app.features.home.room.detail.views.RoomDetailLazyLoadedViews
import chat.progressive.app.features.home.room.detail.widget.RoomWidgetsBottomSheet
...
import chat.progressive.app.features.html.EventHtmlRenderer
import chat.progressive.app.features.invite.ProgressiveInviteView
...
import chat.progressive.app.features.widgets.WidgetArgs
import chat.progressive.app.features.widgets.WidgetKind
import chat.progressive.app.features.widgets.permissions.RoomWidgetPermissionBottomSheet
    ...
    private fun showTranslatedText(text: String) {
        MaterialAlertDialogBuilder(requireContext())
            ...
            .setPositiveButton(CommonStrings.action_copy) { _, _ ->
                copyToClipboard(requireContext(), text, false, CommonStrings.translate_action)
            }
        ...
        withState(timelineViewModel) { state ->
            ...
            if (widgetsCount == 0 || hasOnlyJitsiWidget) {
                ...
                actionView
                        ...
                        ?.setColorFilter(ThemeUtils.getColor(requireContext(), chat.progressive.lib.ui.styles.R.attr.vctr_content_secondary))
    ...
    private fun updateMenuThreadNotificationBadge(menu: Menu, state: RoomDetailViewState) {
        ...
        if (unreadThreadMessages > 0) {
            ...
            val color = ContextCompat.getColor(
                    requireContext(),
                    if (userIsMentioned) chat.progressive.lib.ui.styles.R.color.palette_vermilion else chat.progressive.lib.ui.styles.R.color.palette_gray_200
            )
                ...
                when {
                    data.spam -> {
                        MaterialAlertDialogBuilder(
                                requireActivity(),
                                chat.progressive.lib.ui.styles.R.style.ThemeOverlay_Vector_MaterialAlertDialog_NegativeDestructive
                        )
...
//                        roomId = timelineArgs.roomId,
    ...
    private fun displayUrlConfirmationDialog(seenUrl: String, actualUrl: String, continueTo: String = actualUrl) {
        MaterialAlertDialogBuilder(requireActivity(), chat.progressive.lib.ui.styles.R.style.ThemeOverlay_Vector_MaterialAlertDialog_NegativeDestructive)
                ...
                .setMessage(
                        getString(CommonStrings.external_link_confirmation_message, seenUrl, actualUrl)
                                .toSpannable()
                                .colorizeMatchingText(actualUrl, colorProvider.getColorFromAttribute(chat.progressive.lib.ui.styles.R.attr.vctr_content_tertiary))
                                .colorizeMatchingText(seenUrl, colorProvider.getColorFromAttribute(chat.progressive.lib.ui.styles.R.attr.vctr_content_tertiary))
                )
    ...
    override fun getPreviewUrlRetriever() = timelineViewModel.previewUrlRetriever
    ...
    private fun askConfirmationToEndPoll(eventId: String) {
        MaterialAlertDialogBuilder(requireContext(), chat.progressive.lib.ui.styles.R.style.ThemeOverlay_Vector_MaterialAlertDialog)
    ...
    private fun askConfirmationToIgnoreUser(senderId: String) {
        MaterialAlertDialogBuilder(requireContext(), chat.progressive.lib.ui.styles.R.style.ThemeOverlay_Vector_MaterialAlertDialog_Destructive)
