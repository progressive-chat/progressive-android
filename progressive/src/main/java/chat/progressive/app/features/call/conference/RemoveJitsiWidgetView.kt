...
import chat.progressive.app.databinding.ViewRemoveJitsiWidgetBinding
...
@SuppressLint("ClickableViewAccessibility") class RemoveJitsiWidgetView @JvmOverloads constructor(
    ...
    private fun ViewRemoveJitsiWidgetBinding.updateHangupColors(activated: Boolean) {
        ...
        val bgColor: Int
        if (activated) {
            bgColor = ContextCompat.getColor(context, chat.progressive.lib.ui.styles.R.color.palette_vermilion)
            iconTintColor = ContextCompat.getColor(context, chat.progressive.lib.ui.styles.R.color.palette_white)
        } else {
            bgColor = ContextCompat.getColor(context, android.R.color.transparent)
            iconTintColor = ContextCompat.getColor(context, chat.progressive.lib.ui.styles.R.color.palette_vermilion)
        }
