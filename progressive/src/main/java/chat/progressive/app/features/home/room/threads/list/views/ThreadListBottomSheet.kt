...
import chat.progressive.app.databinding.BottomSheetThreadListBinding
...
class ThreadListBottomSheet : ProgressiveBottomSheet<BottomSheetThreadListBinding>() {
    ...
    private fun renderState(state: ThreadListViewState) {
        ...
        if (state.shouldFilterThreads) {
            setRightIconDrawableAllThreads(radioOffDrawable, chat.progressive.lib.ui.styles.R.attr.vctr_content_secondary)
            ...
            setRightIconDrawableMyThreads(radioOffDrawable, chat.progressive.lib.ui.styles.R.attr.vctr_content_secondary)
        }
    }
