...
import chat.progressive.app.features.login.TextInputFormFragmentMode
...
import chat.progressive.app.features.onboarding.OnboardingVariant
...
import chat.progressive.app.features.onboarding.ftueauth.terms.FtueAuthLegacyStyleTermsFragment
import chat.progressive.app.features.onboarding.ftueauth.terms.FtueAuthTermsFragment
import chat.progressive.app.features.onboarding.ftueauth.terms.FtueAuthTermsLegacyStyleFragmentArgument
...
class FtueAuthVariant(
    ...
    private val commonOption: (FragmentTransaction) -> Unit = { ft ->
        ...
        (topFragment?.view as? ViewGroup)
                ...
                ?.children
                ?.firstOrNull { it.id == chat.progressive.lib.ui.styles.R.id.loginLogo }
