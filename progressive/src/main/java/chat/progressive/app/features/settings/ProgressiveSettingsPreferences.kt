...
import chat.progressive.app.core.dialogs.PhotoOrVideoDialog
import chat.progressive.app.core.extensions.restart
import chat.progressive.app.core.preference.ProgressiveListPreference
                ...
                context?.let { context: Context ->
                    MaterialAlertDialogBuilder(context)
                            .setSingleChoiceItems(
                                    chat.progressive.lib.strings.R.array.media_saving_choice,
