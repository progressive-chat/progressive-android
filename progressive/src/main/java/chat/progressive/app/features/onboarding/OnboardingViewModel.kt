...
import chat.progressive.app.core.extensions.cancelCurrentOnSet
import chat.progressive.app.core.extensions.inferNoConnectivity
...
class OnboardingViewModel @AssistedInject constructor(
    ...
    private val matrixOrgUrl = stringProvider.getString(chat.progressive.app.config.R.string.matrix_org_server_url).ensureTrailingSlash()
