...
import chat.progressive.app.databinding.ItemRoomCategoryBinding
...
class SectionHeaderAdapter constructor(
    ...
    class VH constructor(
        ...
        fun bind(roomsSectionData: RoomsSectionData) {
            ...
            val tintColor = ThemeUtils.getColor(binding.root.context, chat.progressive.lib.ui.styles.R.attr.vctr_content_secondary)
