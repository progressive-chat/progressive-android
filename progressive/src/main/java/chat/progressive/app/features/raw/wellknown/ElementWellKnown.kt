...
data class ElementWellKnown(
         ...
         */
        @Json(name = "chat.progressive.riot.jitsi")
        ...
        @Json(name = "chat.progressive.riot.e2ee")
...
data class E2EWellKnownConfig(
        ...
        /**
         * Configuration for sharing keys strategy which should be used instead of [chat.progressive.app.config.Config.KEY_SHARING_STRATEGY].
