...
import chat.progressive.app.core.extensions.isMatrixId
...
class PillImageSpan(
    ...
    private fun createChipDrawable(): ChipDrawable {
        val textPadding = context.resources.getDimension(chat.progressive.lib.ui.styles.R.dimen.pill_text_padding)
        val icon = when {
        ...
        return ChipDrawable.createFromResource(context, R.xml.pill_view).apply {
            ...
            setChipMinHeightResource(chat.progressive.lib.ui.styles.R.dimen.pill_min_height)
            setChipIconSizeResource(chat.progressive.lib.ui.styles.R.dimen.pill_avatar_size)
            chipIcon = icon
            if (matrixItem is MatrixItem.EveryoneInRoomItem) {
                ...
                setTextAppearanceResource(chat.progressive.lib.ui.styles.R.style.TextAppearance_Vector_Body_OnError)
            }
