...
abstract class MessageVoiceItem : AbsMessageItem<MessageVoiceItem.Holder>() {
    ...
    override fun bind(holder: Holder) {
        ...
        val backgroundTint = if (attributes.informationData.messageLayout is TimelineMessageLayout.Bubble) {
            ...
            ThemeUtils.getColor(holder.view.context, chat.progressive.lib.ui.styles.R.attr.vctr_content_quinary)
        }
    ...
    private fun onWaveformViewReady(holder: Holder) {
        ...
        val waveformColorIdle = ThemeUtils.getColor(holder.view.context, chat.progressive.lib.ui.styles.R.attr.vctr_content_quaternary)
        val waveformColorPlayed = ThemeUtils.getColor(holder.view.context, chat.progressive.lib.ui.styles.R.attr.vctr_content_secondary)
