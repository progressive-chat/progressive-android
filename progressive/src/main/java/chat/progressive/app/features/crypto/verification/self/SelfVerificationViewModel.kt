...
import chat.progressive.app.features.crypto.verification.user.toDataClass
...
class SelfVerificationViewModel @AssistedInject constructor(
        ...
        ProgressiveViewModel<SelfVerificationViewState, VerificationAction, VerificationBottomSheetViewEvents>(initialState) {
