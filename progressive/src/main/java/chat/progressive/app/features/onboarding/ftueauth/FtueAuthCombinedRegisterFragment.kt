...
import chat.progressive.app.core.extensions.hasSurroundingSpaces
...
import chat.progressive.app.core.extensions.onTextChange
...
import chat.progressive.app.databinding.FragmentFtueCombinedRegisterBinding
...
import chat.progressive.app.features.onboarding.OnboardingAction.AuthenticateAction
...
class FtueAuthCombinedRegisterFragment :
    ...
    private fun OnboardingViewState.isNumericOnlyUserIdForbidden() =
            selectedHomeserver.userFacingUrl == getString(chat.progressive.app.config.R.string.matrix_org_server_url)
}
