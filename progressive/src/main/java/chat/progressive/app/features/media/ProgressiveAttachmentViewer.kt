...
import chat.progressive.lib.attachmentviewer.AttachmentCommands
import chat.progressive.lib.attachmentviewer.AttachmentViewerActivity
...
class ProgressiveAttachmentViewer : AttachmentViewerActivity(), AttachmentInteractionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        window.statusBarColor = ContextCompat.getColor(this, chat.progressive.lib.ui.styles.R.color.black_alpha)
        @Suppress("DEPRECATION")
        window.navigationBarColor = ContextCompat.getColor(this, chat.progressive.lib.ui.styles.R.color.black_alpha)
