...
import chat.progressive.app.core.epoxy.profiles.profileMatrixItemWithPowerLevel
                                                            ...
                                                            span {
                                                                span(host.stringProvider.getString(CommonStrings.invited)) {
                                                                    textColor = host.colorProvider.getColorFromAttribute(
                                                                            chat.progressive.lib.ui.styles.R.attr.vctr_content_secondary
                                                                    )
                                                                    textStyle = "bold"
                                                            ...
                                                            span {
                                                                span(" $pl ") {
                                                                    backgroundColor = host.colorProvider.getColor(
                                                                            chat.progressive.lib.ui.styles.R.color.notification_accent_color
                                                                    )
