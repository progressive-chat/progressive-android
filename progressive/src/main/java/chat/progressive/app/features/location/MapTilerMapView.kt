...
class MapTilerMapView @JvmOverloads constructor(
    ...
    init {
        context.obtainStyledAttributes(
                attrs,
                chat.progressive.lib.ui.styles.R.styleable.MapTilerMapView,
                0,
                0
        ).use {
    ...
    private fun setLocateButtonVisibility(typedArray: TypedArray) {
        showLocationButton = typedArray.getBoolean(chat.progressive.lib.ui.styles.R.styleable.MapTilerMapView_showLocateButton, false)
    }
            ...
            ImageView(context).apply {
                ...
                updateLayoutParams<MarginLayoutParams> {
                    val marginHorizontal =
                            context.resources.getDimensionPixelOffset(chat.progressive.lib.ui.styles.R.dimen.location_sharing_locate_button_margin_horizontal)
                    val marginVertical =
                            context.resources.getDimensionPixelOffset(chat.progressive.lib.ui.styles.R.dimen.location_sharing_locate_button_margin_vertical)
    ...
    private fun adjustCompassButton(map: MapLibreMap) {
        locateButton.post {
            ...
            val marginRight = context.resources.getDimensionPixelOffset(chat.progressive.lib.ui.styles.R.dimen.location_sharing_compass_button_margin_horizontal)
