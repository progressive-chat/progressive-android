...
import chat.progressive.app.databinding.ActivityHomeBinding
...
import chat.progressive.app.features.home.room.list.home.layout.HomeLayoutSettingBottomDialogFragment
...
import chat.progressive.app.features.permalink.PermalinkHandler.Companion.MATRIX_TO_CUSTOM_SCHEME_URL_BASE
import chat.progressive.app.features.permalink.PermalinkHandler.Companion.ROOM_LINK_PREFIX
import chat.progressive.app.features.permalink.PermalinkHandler.Companion.USER_LINK_PREFIX
import chat.progressive.app.features.popup.DefaultProgressiveAlert
...
import chat.progressive.app.features.spaces.invite.SpaceInviteBottomSheet
    ...
    private fun handlePromptToEnablePush() {
        popupAlertManager.postProgressiveAlert(
                DefaultProgressiveAlert(
                    ...
                    colorInt = ThemeUtils.getColor(this@HomeActivity, chat.progressive.lib.ui.styles.R.attr.vctr_notice_secondary)
