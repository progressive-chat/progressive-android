...
import chat.progressive.app.core.epoxy.bottomSheetDividerItem
...
import chat.progressive.app.features.crypto.verification.epoxy.bottomSheetSelfWaitItem
import chat.progressive.app.features.crypto.verification.epoxy.bottomSheetVerificationActionItem
import chat.progressive.app.features.crypto.verification.epoxy.bottomSheetVerificationNoticeItem
import chat.progressive.app.features.crypto.verification.epoxy.bottomSheetVerificationWaitingItem
import chat.progressive.app.features.crypto.verification.user.BaseEpoxyVerificationController
import chat.progressive.app.features.crypto.verification.user.VerificationTransactionData
import chat.progressive.app.features.crypto.verification.user.bottomDone
import chat.progressive.app.features.crypto.verification.user.gotIt
import chat.progressive.app.features.crypto.verification.user.renderAcceptDeclineRequest
import chat.progressive.app.features.crypto.verification.user.renderCancel
import chat.progressive.app.features.crypto.verification.user.renderQrTransaction
import chat.progressive.app.features.crypto.verification.user.renderSasTransaction
import chat.progressive.app.features.crypto.verification.user.renderStartTransactionOptions
import chat.progressive.app.features.crypto.verification.user.verifiedSuccessTile
        ...
        when (state.pendingRequest) {
            Uninitialized -> {
                ...
                bottomSheetVerificationActionItem {
                    ...
                    iconRes(R.drawable.ic_arrow_right)
                    iconColor(host.colorProvider.getColorFromAttribute(chat.progressive.lib.ui.styles.R.attr.vctr_content_primary))
                    ...
                    EVerificationState.Requested -> {
                        ...
                        if (state.isThisSessionVerified) {
                            bottomSheetVerificationActionItem {
                                ...
                                titleColor(host.colorProvider.getColorFromAttribute(chat.progressive.lib.ui.styles.R.attr.vctr_content_primary))
                                iconRes(R.drawable.ic_arrow_right)
                                iconColor(host.colorProvider.getColorFromAttribute(chat.progressive.lib.ui.styles.R.attr.vctr_content_primary))
                                listener {
