...
import chat.progressive.app.core.utils.startNotificationChannelSettingsIntent
import chat.progressive.app.features.MainActivity
import chat.progressive.app.features.call.ProgressiveCallActivity
import chat.progressive.app.features.call.service.CallHeadsUpActionReceiver
...
import chat.progressive.app.features.settings.troubleshoot.TestNotificationReceiver
...
class NotificationUtils @Inject constructor(
    ...
    fun createNotificationChannels() {
        ...
        val accentColor = ContextCompat.getColor(context, chat.progressive.lib.ui.styles.R.color.notification_accent_color)
        ...
        if (ActivityCompat.checkSelfPermission(context, Manifest.permission.POST_NOTIFICATIONS) != PackageManager.PERMISSION_GRANTED) {
            ...
            notificationManager.notify(
                    ...
                    NotificationCompat.Builder(context, NOISY_NOTIFICATION_CHANNEL_ID)
                            ...
                            .setLargeIcon(getBitmap(context, chat.progressive.lib.ui.styles.R.drawable.element_logo_green))
                            .setColor(ContextCompat.getColor(context, chat.progressive.lib.ui.styles.R.color.notification_accent_color))
