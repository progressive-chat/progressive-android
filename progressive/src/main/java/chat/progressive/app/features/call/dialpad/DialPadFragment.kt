...
package chat.progressive.app.features.call.dialpad
...
class DialPadFragment : Fragment(), TextWatcher {
    ...
    override fun onCreateView(
        ...
        digits.setTextColor(ThemeUtils.getColor(requireContext(), chat.progressive.lib.ui.styles.R.attr.vctr_content_primary))
        ...
        if (enableDelete) {
            ...
            val tintColor = ThemeUtils.getColor(requireContext(), chat.progressive.lib.ui.styles.R.attr.vctr_content_secondary)
