            ...
            .withOptions(
                    UCrop.Options()
                            .apply {
                                ...
                                setToolbarWidgetColor(colorProvider.getColorFromAttribute(chat.progressive.lib.ui.styles.R.attr.vctr_content_primary))
                                // Background
                                ...
                                setStatusBarColor(colorProvider.getColor(chat.progressive.lib.ui.styles.R.color.android_status_bar_background_light))
