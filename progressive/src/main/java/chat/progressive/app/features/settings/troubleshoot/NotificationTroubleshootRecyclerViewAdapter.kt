...
import chat.progressive.app.databinding.ItemNotificationTroubleshootBinding
...
class NotificationTroubleshootRecyclerViewAdapter(val tests: ArrayList<TroubleshootTest>) :
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(test: TroubleshootTest) {
            ...
            views.troubleshootTestTitle.setTextColor(ThemeUtils.getColor(context, chat.progressive.lib.ui.styles.R.attr.vctr_content_primary))
            views.troubleshootTestDescription.setTextColor(ThemeUtils.getColor(context, chat.progressive.lib.ui.styles.R.attr.vctr_content_secondary))

            when (test.status) {
                TroubleshootTest.TestStatus.NOT_STARTED -> {
                    views.troubleshootTestTitle.setTextColor(ThemeUtils.getColor(context, chat.progressive.lib.ui.styles.R.attr.vctr_content_secondary))
