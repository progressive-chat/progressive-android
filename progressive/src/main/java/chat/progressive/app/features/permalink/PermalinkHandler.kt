...
package chat.progressive.app.features.permalink

import android.content.Context
import android.net.Uri
import androidx.fragment.app.FragmentActivity
import chat.progressive.app.core.di.ActiveSessionHolder
import chat.progressive.app.core.extensions.isIgnored
...
class PermalinkHandler @Inject constructor(
    ...
    suspend fun launch(
        ...
        val supportedHosts = fragmentActivity.resources.getStringArray(chat.progressive.app.config.R.array.permalink_supported_hosts)
        return when {
            deepLink == null -> false
