...
import chat.progressive.app.features.notifications.toNotificationAction
...
abstract class PushRuleItem : ProgressiveEpoxyModel<PushRuleItem.Holder>(R.layout.item_pushrule_raw) {
    ...
    override fun bind(holder: Holder) {
        ...
        if (pushRule.enabled) {
            ...
            holder.view.setBackgroundColor(ThemeUtils.getColor(context, chat.progressive.lib.ui.styles.R.attr.vctr_header_background))
