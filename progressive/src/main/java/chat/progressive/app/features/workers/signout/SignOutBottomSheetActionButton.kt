...
import chat.progressive.app.databinding.ViewSignOutBottomSheetActionButtonBinding
...
class SignOutBottomSheetActionButton @JvmOverloads constructor(
    ...
    init {
        inflate(context, chat.progressive.app.R.layout.view_sign_out_bottom_sheet_action_button, this)
