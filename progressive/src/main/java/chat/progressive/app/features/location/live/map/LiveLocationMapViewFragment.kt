...
import chat.progressive.app.databinding.FragmentLiveLocationMapViewBinding
import chat.progressive.app.features.location.LocationData
import chat.progressive.app.features.location.UrlMapProvider
import chat.progressive.app.features.location.showUserLocationNotAvailableErrorDialog
import chat.progressive.app.features.location.zoomToBounds
import chat.progressive.app.features.location.zoomToLocation
...
class LiveLocationMapViewFragment :
    ...
    private fun adjustCompassButton() {
        ...
        locateButton.post {
            ...
            val marginRight =
                    locateButton.context.resources.getDimensionPixelOffset(chat.progressive.lib.ui.styles.R.dimen.location_sharing_compass_button_margin_horizontal)
    ...
    companion object {
        private const val MAP_FRAGMENT_TAG = "chat.progressive.app.features.location.live.map"
