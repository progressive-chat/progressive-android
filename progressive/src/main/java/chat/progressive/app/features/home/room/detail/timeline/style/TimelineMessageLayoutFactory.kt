...
import chat.progressive.app.core.resources.isRTL
...
class TimelineMessageLayoutFactory @Inject constructor(
    ...
    private val cornerRadius: Float by lazy {
        resources.getDimensionPixelSize(chat.progressive.lib.ui.styles.R.dimen.chat_bubble_corner_radius).toFloat()
    }
