...
class ProgressiveBasePreferences @Inject constructor(
    ...
    companion object {
        ...
        const val SETTINGS_LABS_ROOM_COUNT_KEY = "SETTINGS_LABS_ROOM_COUNT_KEY"
        const val SETTINGS_LABS_ROOM_COUNT_SPLIT_KEY = "SETTINGS_LABS_ROOM_COUNT_SPLIT_KEY"
        ...
        const val SETTINGS_LABS_NATIVE_DB_KEY = "SETTINGS_LABS_NATIVE_DB_KEY"
...
//        const val SETTINGS_SECURE_BACKUP_RESET_PREFERENCE_KEY = "SETTINGS_SECURE_BACKUP_RESET_PREFERENCE_KEY"
    ...
    fun userAlwaysAppearsOffline(): Boolean {
        return defaultPrefs.getBoolean(
                ...
                getDefault(chat.progressive.app.config.R.bool.settings_presence_user_always_appears_offline_default)
        )
    }
    ...
    fun isNewAppLayoutEnabled(): Boolean {
        return vectorFeatures.isNewAppLayoutFeatureEnabled() &&
                defaultPrefs.getBoolean(SETTINGS_LABS_NEW_APP_LAYOUT_KEY, getDefault(chat.progressive.app.config.R.bool.settings_labs_new_app_layout_default))
    }
    ...
    fun isClientInfoRecordingEnabled(): Boolean {
        return defaultPrefs.getBoolean(
                ...
                getDefault(
                        chat.progressive.app.config.R.bool.settings_labs_client_info_recording_default
                )
        )
    }
    ...
    fun showLiveSenderInfo(): Boolean {
        return defaultPrefs.getBoolean(
                ...
                getDefault(chat.progressive.app.config.R.bool.settings_timeline_show_live_sender_info_default)
        )
    }
    ...
    fun showIpAddressInSessionManagerScreens(): Boolean {
        return defaultPrefs.getBoolean(
                ...
                getDefault(chat.progressive.app.config.R.bool.settings_session_manager_show_ip_address)
        )
    }
