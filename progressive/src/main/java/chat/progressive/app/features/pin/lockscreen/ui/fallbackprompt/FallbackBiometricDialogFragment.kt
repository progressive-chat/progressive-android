...
import chat.progressive.app.databinding.FragmentBiometricDialogContainerBinding
import chat.progressive.app.databinding.ViewBiometricDialogContentBinding
...
class FallbackBiometricDialogFragment : DialogFragment(R.layout.fragment_biometric_dialog_container) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        requireDialog().setTitle(parsedArgs.title ?: getString(chat.progressive.lib.ui.styles.R.string.lockscreen_sign_in))
    }
    ...
    private fun renderSuccess() {
        ...
        contentBinding.fingerprintStatus.apply {
            setTextColor(ResourcesCompat.getColor(resources, chat.progressive.lib.ui.styles.R.color.lockscreen_success_color, null))
            setText(chat.progressive.lib.ui.styles.R.string.lockscreen_fingerprint_success)
        }
        viewLifecycleOwner.lifecycleScope.launch {
            delay(200L)
            dismiss()
    ...
    private fun renderFailure() {
        ...
        contentBinding.fingerprintStatus.apply {
            setTextColor(ResourcesCompat.getColor(resources, chat.progressive.lib.ui.styles.R.color.lockscreen_warning_color, null))
            setText(chat.progressive.lib.ui.styles.R.string.lockscreen_fingerprint_not_recognized)
        }
        viewLifecycleOwner.lifecycleScope.launch {
            delay(1500L)
            resetState()
    ...
    private fun resetState() {
        ...
        contentBinding.fingerprintStatus.apply {
            setTextColor(ResourcesCompat.getColor(resources, chat.progressive.lib.ui.styles.R.color.lockscreen_hint_color, null))
            setText(chat.progressive.lib.ui.styles.R.string.lockscreen_fingerprint_hint)
        }
    }
