...
import chat.progressive.app.core.extensions.setTextColor
...
import chat.progressive.app.features.settings.devices.v2.filter.DeviceManagerFilterBottomSheet
import chat.progressive.app.features.settings.devices.v2.filter.DeviceManagerFilterType
import chat.progressive.app.features.settings.devices.v2.list.OtherSessionsView
import chat.progressive.app.features.settings.devices.v2.list.SESSION_IS_MARKED_AS_INACTIVE_AFTER_DAYS
import chat.progressive.app.features.settings.devices.v2.more.SessionLearnMoreBottomSheet
import chat.progressive.app.features.settings.devices.v2.signout.BuildConfirmSignoutDialogUseCase
            ...
            DeviceManagerFilterType.VERIFIED -> {
                views.otherSessionsSecurityRecommendationView.render(
                        OtherSessionsSecurityRecommendationViewState(
                                ...
                                imageTintColorResourceId = colorProvider.getColor(chat.progressive.lib.ui.styles.R.color.shield_color_trust_background)
                        )
                )
            ...
            DeviceManagerFilterType.UNVERIFIED -> {
                views.otherSessionsSecurityRecommendationView.render(
                        OtherSessionsSecurityRecommendationViewState(
                                ...
                                imageTintColorResourceId = colorProvider.getColor(chat.progressive.lib.ui.styles.R.color.shield_color_warning_background)
                        )
                )
            ...
            DeviceManagerFilterType.INACTIVE -> {
                views.otherSessionsSecurityRecommendationView.render(
                        OtherSessionsSecurityRecommendationViewState(
                                ...
                                imageTintColorResourceId = ThemeUtils.getColor(requireContext(), chat.progressive.lib.ui.styles.R.attr.vctr_system)
                        )
                )
