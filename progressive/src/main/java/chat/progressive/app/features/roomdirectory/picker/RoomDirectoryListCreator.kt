...
import chat.progressive.app.core.resources.StringArrayProvider
...
class RoomDirectoryListCreator @Inject constructor(
    ...
    fun computeDirectories(
        ...
        stringArrayProvider.getStringArray(chat.progressive.app.config.R.array.room_directory_servers)
