        ...
        alerter.setTitle(alert.title)
                ...
                .apply {
                    ...
                    alert.actions.forEach { action ->
                        addButton(action.title, chat.progressive.lib.ui.styles.R.style.Widget_Vector_Button_Text_Alerter) {
                            if (action.autoClose) {
                                currentIsDismissed()
                                Alerter.hide()
                            }
                ...
                .apply {
                    if (alert.colorInt != null) {
                        ...
                        setBackgroundColorRes(alert.colorRes ?: chat.progressive.lib.ui.styles.R.color.notification_accent_color)
                    }
                }
