...
package chat.progressive.app.features.home.room.threads.list.views
...
import chat.progressive.app.features.home.room.detail.timeline.animation.TimelineItemAnimator
...
import chat.progressive.app.features.home.room.threads.list.viewmodel.ThreadListController
import chat.progressive.app.features.home.room.threads.list.viewmodel.ThreadListPagedController
import chat.progressive.app.features.home.room.threads.list.viewmodel.ThreadListViewActions
import chat.progressive.app.features.home.room.threads.list.viewmodel.ThreadListViewEvents
import chat.progressive.app.features.home.room.threads.list.viewmodel.ThreadListViewModel
import chat.progressive.app.features.home.room.threads.list.viewmodel.ThreadListViewState
...
class ThreadListFragment :
    ...
    private fun initBetaFeedback() {
        views.threadsFeedBackConstraintLayout.isVisible = resources.getBoolean(chat.progressive.app.config.R.bool.feature_threads_beta_feedback_enabled)
        views.threadFeedbackDivider.isVisible = resources.getBoolean(chat.progressive.app.config.R.bool.feature_threads_beta_feedback_enabled)
