...
import chat.progressive.app.core.ui.list.genericHeaderItem
                        ...
                        diff.map {
                            when (it.operation) {
                                ...
                                diff_match_patch.Operation.INSERT -> {
                                    span {
                                        text = it.text
                                        textColor = colorProvider.getColor(chat.progressive.lib.ui.styles.R.color.palette_element_green)
                                    }
                                }
                                else -> {
                                    span {
