...
import chat.progressive.app.config.R
...
class BugReporter @Inject constructor(
    ...
    private fun rageShakeAppNameForReport(reportType: ReportType): String {
        ...
        return context.getString(
                when (reportType) {
                    ReportType.AUTO_UISI_SENDER,
                    ReportType.AUTO_UISI -> chat.progressive.app.config.R.string.bug_report_auto_uisi_app_name
                    else -> chat.progressive.app.config.R.string.bug_report_app_name
                }
        )
    }
// ==============================================================================================================
