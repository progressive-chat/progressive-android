...
import chat.progressive.app.core.glide.GlideRequest
import chat.progressive.app.core.glide.GlideRequests
import chat.progressive.app.core.ui.model.Size
...
class ImageContentRenderer @Inject constructor(
    ...
    fun render(previewUrlData: PreviewUrlData, imageView: ImageView): Boolean {
        ...
        val maxHeight = dimensionConverter.resources.getDimensionPixelSize(chat.progressive.lib.ui.styles.R.dimen.preview_url_view_image_max_height)
