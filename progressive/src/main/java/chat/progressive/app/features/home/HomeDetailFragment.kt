...
import chat.progressive.app.databinding.FragmentHomeDetailBinding
...
class HomeDetailFragment :
    ...
    private fun BadgeDrawable.render(count: Int, highlight: Boolean) {
        ...
        backgroundColor = if (highlight) {
            ...
            ThemeUtils.getColor(requireContext(), chat.progressive.lib.ui.styles.R.attr.vctr_unread_background)
        }
    }
