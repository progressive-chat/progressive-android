...
import chat.progressive.app.core.epoxy.errorWithRetryItem
...
import chat.progressive.app.core.ui.list.Action
import chat.progressive.app.core.ui.list.genericEmptyWithActionItem
import chat.progressive.app.core.ui.list.genericPillItem
import chat.progressive.app.features.home.AvatarRenderer
import chat.progressive.app.features.home.room.list.spaceChildInfoItem
import chat.progressive.app.features.home.room.list.spaceDirectoryFilterNoResultsItem
import chat.progressive.app.features.spaces.manage.SpaceChildInfoMatchFilter
        ...
        if (results is Incomplete) {
            ...
            if (flattenChildInfo.isEmpty()) {
                genericEmptyWithActionItem {
                    ...
                    iconTint(host.colorProvider.getColorFromAttribute(chat.progressive.lib.ui.styles.R.attr.vctr_reaction_background_on))
                    apply {
