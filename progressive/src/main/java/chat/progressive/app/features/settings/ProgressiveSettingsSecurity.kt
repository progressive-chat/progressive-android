...
import chat.progressive.app.core.dialogs.ExportKeysDialog
import chat.progressive.app.core.extensions.queryExportKeys
import chat.progressive.app.core.extensions.registerStartForActivityResult
import chat.progressive.app.core.intent.ExternalIntentData
import chat.progressive.app.core.intent.analyseIntent
...
import chat.progressive.app.core.utils.openFileSelection
...
import chat.progressive.app.features.crypto.keys.KeysExporter
import chat.progressive.app.features.crypto.keys.KeysImporter
    ...
    override fun bindPref() {
        ...
        secureBackupPreference.icon = activity?.let {
            ThemeUtils.tintDrawable(
                    it,
                    ContextCompat.getDrawable(it, R.drawable.ic_secure_backup)!!, chat.progressive.lib.ui.styles.R.attr.vctr_content_primary
            )
        }
        ...
        ignoredUsersPreference.icon = activity?.let {
            ThemeUtils.tintDrawable(
                    it,
                    ContextCompat.getDrawable(it, R.drawable.ic_settings_root_ignored_users)!!, chat.progressive.lib.ui.styles.R.attr.vctr_content_primary
            )
        }
