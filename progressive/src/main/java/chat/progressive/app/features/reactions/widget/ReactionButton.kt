 ...
 */
package chat.progressive.app.features.reactions.widget
...
import chat.progressive.app.databinding.ReactionButtonBinding
...
class ReactionButton @JvmOverloads constructor(
        ...
        defStyleAttr: Int = 0,
        defStyleRes: Int = chat.progressive.lib.ui.styles.R.style.TimelineReactionView
) :
    ...
    init {
        ...
        context.withStyledAttributes(attrs, chat.progressive.lib.ui.styles.R.styleable.ReactionButton, defStyleAttr) {
            ...
            getString(chat.progressive.lib.ui.styles.R.styleable.ReactionButton_emoji)?.let {
                reactionString = it
            }
            reactionCount = getInt(chat.progressive.lib.ui.styles.R.styleable.ReactionButton_reaction_count, 0)
            val status = getBoolean(chat.progressive.lib.ui.styles.R.styleable.ReactionButton_toggled, false)
            setChecked(status)
        }
