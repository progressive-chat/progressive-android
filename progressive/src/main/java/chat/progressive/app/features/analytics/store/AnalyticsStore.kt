...
package chat.progressive.app.features.analytics.store
...
/**
 * Also accessed via reflection by the instrumentation tests @see [chat.progressive.app.ClearCurrentSessionRule].
 */
