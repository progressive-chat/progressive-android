...
import chat.progressive.app.databinding.BottomSheetVerificationBinding
                            ...
                            .setMessage(
                                    getString(CommonStrings.verify_cancel_other, event.otherUserId, event.deviceId ?: "*")
                                            ...
                                            .colorizeMatchingText(
                                                    event.otherUserId,
                                                    ThemeUtils.getColor(requireContext(), chat.progressive.lib.ui.styles.R.attr.vctr_notice_text_color)
                                            )
                            )
                            .setCancelable(false)
