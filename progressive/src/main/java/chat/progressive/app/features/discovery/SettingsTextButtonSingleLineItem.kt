...
import chat.progressive.app.core.epoxy.attributes.ButtonType
import chat.progressive.app.core.epoxy.attributes.IconMode
...
@EpoxyModelClass
abstract class SettingsTextButtonSingleLineItem : ProgressiveEpoxyModel<SettingsTextButtonSingleLineItem.Holder>(R.layout.item_settings_button_single_line) {
    ...
    override fun bind(holder: Holder) {
        ...
        when (iconMode) {
            ...
            IconMode.INFO -> {
                val errorColor = colorProvider.getColor(chat.progressive.lib.ui.styles.R.color.notification_accent_color)
