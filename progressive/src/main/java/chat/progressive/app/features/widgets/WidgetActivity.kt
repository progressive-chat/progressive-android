...
import chat.progressive.app.databinding.ActivityWidgetBinding
import chat.progressive.app.features.widgets.permissions.RoomWidgetPermissionBottomSheet
import chat.progressive.app.features.widgets.permissions.RoomWidgetPermissionViewEvents
...
import chat.progressive.lib.core.utils.compat.getSerializableCompat
...
class WidgetActivity : ProgressiveActivity<ActivityWidgetBinding>() {
    ...
    private fun createElementCallPipParams(): PictureInPictureParams? {
        ...
        val icon = Icon.createWithResource(this, chat.progressive.app.R.drawable.ic_call_hangup)
