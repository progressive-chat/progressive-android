...
import chat.progressive.app.databinding.BottomSheetRoomWidgetPermissionBinding
...
class RoomWidgetPermissionBottomSheet :
    ...
    override fun invalidate() = withState(viewModel) { state ->
        ...
        permissionData.permissionsList.forEach {
            ...
            infoBuilder.append(
                    bulletPoint,
                    BulletSpan(resources.getDimension(chat.progressive.lib.ui.styles.R.dimen.quote_gap).toInt()),
