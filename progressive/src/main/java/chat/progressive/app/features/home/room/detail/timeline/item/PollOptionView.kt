...
import chat.progressive.app.databinding.ItemPollOptionBinding
...
class PollOptionView @JvmOverloads constructor(
    ...
    private fun renderPollEnded(state: PollOptionViewState.PollEnded) {
        ...
        views.optionVoteCountTextView.setTextColor(
                ...
                else ThemeUtils.getColor(context, chat.progressive.lib.ui.styles.R.attr.vctr_content_secondary)
        )
    ...
    private fun renderVoteSelection(isSelected: Boolean) {
        if (isSelected) {
            ...
            views.optionBorderImageView.setAttributeTintedImageResource(R.drawable.bg_poll_option, chat.progressive.lib.ui.styles.R.attr.vctr_content_quinary)
