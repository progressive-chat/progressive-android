...
class JitsiService @Inject constructor(
    ...
    private val jitsiWidgetDataFactory by lazy {
        JitsiWidgetDataFactory(stringProvider.getString(chat.progressive.app.config.R.string.preferred_jitsi_domain)) { widget ->
    ...
    suspend fun createJitsiWidget(roomId: String, withVideo: Boolean): Widget {
        ...
        val jitsiDomain = preferredJitsiDomain ?: stringProvider.getString(chat.progressive.app.config.R.string.preferred_jitsi_domain)
