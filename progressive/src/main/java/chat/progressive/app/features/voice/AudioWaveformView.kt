        ...
        attrs?.let {
            context
                    ...
                    .obtainStyledAttributes(
                            attrs,
                            chat.progressive.lib.ui.styles.R.styleable.AudioWaveformView,
                            0,
                            0
                    )
                    .apply {
                        alignment = Alignment.values().find {
                            it.value == getInt(chat.progressive.lib.ui.styles.R.styleable.AudioWaveformView_alignment, alignment.value)
                        }!!
                        flow = Flow.values().find { it.value == getInt(chat.progressive.lib.ui.styles.R.styleable.AudioWaveformView_flow, alignment.value) }!!
                        verticalPadding = getDimension(chat.progressive.lib.ui.styles.R.styleable.AudioWaveformView_verticalPadding, verticalPadding)
                        horizontalPadding = getDimension(chat.progressive.lib.ui.styles.R.styleable.AudioWaveformView_horizontalPadding, horizontalPadding)
                        barWidth = getDimension(chat.progressive.lib.ui.styles.R.styleable.AudioWaveformView_barWidth, barWidth)
                        barSpace = getDimension(chat.progressive.lib.ui.styles.R.styleable.AudioWaveformView_barSpace, barSpace)
                        barMinHeight = getDimension(chat.progressive.lib.ui.styles.R.styleable.AudioWaveformView_barMinHeight, barMinHeight)
                        isBarRounded = getBoolean(chat.progressive.lib.ui.styles.R.styleable.AudioWaveformView_isBarRounded, isBarRounded)
